 ...
 const fetchSubcategories = async () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = { name, mappedParent:category, metaTitle, metaKeyword, metaDescription,imageUrl };
  ...
  const printParentMap = (s1:string, s2:string)=>{
    console.log(s1,s2)
  }
                  ...
                  {categories.map((cat, index) => (
                    ...
                    >
                      ...
                      {editingCategory === cat._id ? (
                        <>
                          <>
                           {/* <td className="p-3 overflow-x-hidden max-w-72 text-justify">{cat.categoryId}</td> */}
                           {/* <td className="p-3 overflow-x-hidden max-w-72">{subcategories.map((s) => (
                        (s._id === cat.mappedParent) ? s.sub_cat_name : ""
                        printParentMap(s._id,cat.mappedParent)                        
                        ))}</td> */}
...
//       const payload = { name, mappedParent: category, metaTitle, metaDescription, metaKeyword, imageUrl };
...
//                       {/* Image */}
//                       <td className="p-3">
//                         {((cat.name != "null") && (cat.imageUrl != undefined)) ? (
//                           <a
//                             href={cat.imageUrl}
//                             target="_blank"
//                             rel="noopener noreferrer"
